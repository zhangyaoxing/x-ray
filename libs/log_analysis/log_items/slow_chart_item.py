...
class SlowChartItem(BaseItem):
    ...
    def review_results_markdown(self, f):
        ...
        f.write(f"<canvas id=\"canvas_{self.__class__.__name__}_scanned\" height=\"200\"></canvas>\n")
        f.write(f"<canvas id=\"canvas_{self.__class__.__name__}_scannedObj\" height=\"200\"></canvas>\n")
